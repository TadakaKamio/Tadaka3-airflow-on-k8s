...
使用例:
 /opt/mapr/spark/spark-3.3.1/bin/spark-submit\
    ...
    --conf "spark.executor.instances=30" \
    --name "P006_unload" \
    "/home/mapr/script/airflow/P006/P006_unload_spark_zip.py" "/tdh/volume7/unload/dwh_d30_lo_sm_corr" "pgss1" "dwh_d30_lo_sm_corr" "SM_D30_LO_HC" "20240501" "20240301"
"""
...
try:
    ...
    DF_ZIP_PATH = f"{DF_WORK_DIR}/{CSV_PREFIX}_{CURRENT_DATE}_{TARGETYMD}.zip" # /tdh/volume7/unload/dwh_d30_lo_sm_corr/SM_D30_LO_HC_20240403_20230502.zip
    ...
    TMP_ZIP_PATH = f"/tmp/{CSV_PREFIX}_{CURRENT_DATE}_{TARGETYMD}_{RANDOM_STR}.zip" # /tmp/SM_D30_LO_HC_20240403_20230502_6fa459ea-ee8a-11d9-9c12-0011098af96b.zip
    ...
    # TMP_CSV_PATHをzipに圧縮してTMP_ZIP_PATHに保存
    logger.info("=== START: Creating a zip file ===")
    subprocess.run(["zip", "-j", TMP_ZIP_PATH, TMP_CSV_PATH], check=True)
    logger.info(f"=== END: Success to create the zip file {TMP_ZIP_PATH}. ===")
